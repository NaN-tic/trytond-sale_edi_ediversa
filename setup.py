...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-sale_edi_ediversa',
    download_url='https://github.com:nantic/trytond-sale_edi_ediversa.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-sale_edi_ediversa.git'
    },
    classifiers=[
